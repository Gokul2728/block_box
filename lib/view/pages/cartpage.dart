...
class _CartPageState extends State<CartPage> {
  ...
  void initState() {
    ...
    card1Controller = TextEditingController();
    card2Controller = TextEditingController();
    card3Controller = TextEditingController();
    card4Controller = TextEditingController();
    monthController = TextEditingController();
    dayController = TextEditingController();
    cvv2Controller = TextEditingController();
    super.initState();
  }
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          icon: Image.network(
                                            'https://raw.githubusercontent.com/iogroupteam/my_wallet/master/assets/6.png',
  ...
  Widget CarditItem(TextEditingController controller, FocusNode myFocus,
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration:
            const InputDecoration(border: InputBorder.none, hintText: 'xxxx'),
      ),
    );
  }
